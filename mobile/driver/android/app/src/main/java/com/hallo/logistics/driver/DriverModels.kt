...
data class DriverUiState(
    ...
    val jobsAvailable:Boolean=false,
    val activeTrip:DriverJob?=null,
    val activeTripAvailable:Boolean=false,
    val trucks:List<DriverTruck> = emptyList(),
    val trucksAvailable:Boolean=false,
    ...
    val tripResultsAvailable:Boolean=false,
    val commissionPayments:List<DriverCommissionPayment> = emptyList(),
    val commissionPaymentsAvailable:Boolean=false,
    val depositTransactions:List<DriverDepositTransaction> = emptyList(),
    val depositTransactionsAvailable:Boolean=false,
    val completedTrips:List<DriverJob> = emptyList(),
    val completedTripsAvailable:Boolean=false,
