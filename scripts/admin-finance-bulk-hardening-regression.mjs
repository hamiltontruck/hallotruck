...
const checks = [
  ...
  [service.includes("basePaymentsQuery.limit(ADMIN_DASHBOARD_FINANCE_PREVIEW_LIMIT)"), "payments preview is bounded"],
  [service.includes("baseProofsQuery.limit(ADMIN_DASHBOARD_FINANCE_PREVIEW_LIMIT)"), "delivery proof preview is bounded"],
