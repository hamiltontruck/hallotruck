...
const fixture = {
  ...
  settlementPayments: [{ id:'settlement-payment-1', request_key:'payment-request-1', settlement_id:'settlement-1', partner_id:'partner-fixture', amount_etb:100000, payment_method:'bank_transfer', provider:'Commercial Bank of Ethiopia Enterprise Transfer', transaction_ref:'CBE-ENTERPRISE-TRANSACTION-REFERENCE-12345678901234567890', paid_at:${JSON.stringify(now)}, recorded_by:'admin-1', created_at:${JSON.stringify(now)} }],
  settlementEvents: [{ id:1, settlement_id:'settlement-1', partner_id:'partner-fixture', event_type:'partially_paid', from_status:'approved', to_status:'partially_paid', amount_etb:100000, reason:null, actor_id:'admin-1', metadata:{}, created_at:${JSON.stringify(now)} }],
