...
export function AdminDriverDocumentsShortcut() {
  ...
  return (
    <a
      ...
      aria-label="Open driver document verification"
    >
      ...
      <span className="min-w-0 flex-1">
        <span className="block font-display text-sm font-semibold">Driver documents</span>
        <span className="mt-0.5 block text-[11px] text-white/55">
          {pendingFiles === null ? "Checking verification files…" : `${pendingFiles} pending review`}
