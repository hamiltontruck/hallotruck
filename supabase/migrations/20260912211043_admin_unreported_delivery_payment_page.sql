...
-- Server-paginated leadership queue for delivered pay-on-delivery orders that
-- still have no immutable driver trip payment result. Reporting only: no
-- business row is inserted, updated, deleted or backfilled by this migration.
