  ...
  loop
    ...
    begin
      ...
      values (
        ...
        public.st_setsrid(public.st_makepoint(p_pickup_longitude::double precision, p_pickup_latitude::double precision), 4326)::public.geography,
        btrim(p_dropoff_address),
        public.st_setsrid(public.st_makepoint(p_dropoff_longitude::double precision, p_dropoff_latitude::double precision), 4326)::public.geography,
