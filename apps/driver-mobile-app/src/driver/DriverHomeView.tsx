...
export type DriverWorkspaceDestination = "home" | "jobs" | "trip" | "wallet" | "profile" | "alerts" | "support";
  ...
  return <main className="min-h-[calc(100dvh-137px)] bg-halo-canvas px-4 pb-8 pt-5 sm:px-6" data-mobile-driver-home aria-busy={refreshing}>
    ...
    <section className="mt-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Action title="HALLO Support" detail="Secure Operations chat" onClick={() => onNavigate("support")} />
      </div>
    </section>
  </main>;
}
